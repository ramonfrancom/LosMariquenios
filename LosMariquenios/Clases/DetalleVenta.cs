...
namespace LosMariquenios.Clases
{
    class DetalleVenta : Detalle
    {
        ...
        public DetalleVenta(string codigo_barras, int cantidad)
        {
        ...
        {
            get { return cantidad; }
            set { cantidad = value; sacarTotal(); }
        }
        public float Precio
        {
            get { return precio; }
            set { precio = value; sacarTotal(); }
        }
        public float Total
        {
            get { return total; }
        ...
        public void InsertSellDetail(string folio_venta)
        {
            //==================================================================//==================================================================
            //usuario.PassUser = PasswordHash.HashPassword(usuario.PassUser);
            string query = $@"INSERT INTO detalles_venta (folio_venta, codigo_barras_producto, cantidad, precio) 
                            VALUES({ Convert.ToInt32(folio_venta) },'{ codigo_barras_producto }',{ this.cantidad },{ this.precio });";
            ...
            try
            {
                ...
                if (OpenConnection() == true)
                {
                    ...
                    MySqlCommand cmdSell = new MySqlCommand(query, dataBaseConnection);
        ...
        {
            //==================================================================//==================================================================
            string query = $@"SELECT nombre, existencia, precio FROM productos WHERE codigo_barras = '{codigo_barras}';";
            ...
            if (OpenConnection() == true)
            {
                ...
                if (dataReader.Read())
                {
                    ...
                    this.precio = Convert.ToInt32($"{dataReader.GetString("precio")}");
                }
                //close Data Reader
                dataReader.Close();
